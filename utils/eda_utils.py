...
def custom_box_plot_one_var(data_: pd.DataFrame, column_: str = None) -> None:
    # Create a box plot
    colors = {'bad': 'red', 'good': 'green'}
    plt.figure(figsize=(7, 6))
    sns.boxplot(data_[column_], vert = True)
    plt.title(f'Box Plot of {column_}')
    plt.xlabel(f'{column_}')
